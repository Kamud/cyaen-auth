...
export default function Home() {
  ...
  switch (status) {
    case "no_auth":
      txt = "You must be authenticated to access that route";
      break;
    case "expired":
      txt = "Your session has expired, please reauthenticate";
      break;
    case "invalid":
      txt = "Your requested session is not valid, please reauthenticate";
      break;
    default:
      txt = "welcome to our client site";
  }
  ...
  const verifyToken = async (e) => {
    ...
    try {
      ...
      if (res.data.status === "success") {
        ...
        setTimeout(() => {
          if (url) {
            window.location = `${url}?rqid=${res.data.auth_id}`;
          } else {
  ...
  return (
    <div className={styles.container}>
      ...
      <header className="header text-white text-center">
        ...
        <h1 className="heading-1 fw-re  mt-4">{txt}</h1>
